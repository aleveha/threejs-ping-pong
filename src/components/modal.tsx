...
export const Modal: FC<Props> = ({ isBallMovingRight, isEnded, isOpen, onClick }) => {
	return (
		<div
			className={clsx(
		...
		>
			<div className="flex flex-col items-center space-y-12 rounded-3xl bg-white p-16 text-indigo-900 shadow-2xl">
				<h1 className="text-center font-mono text-4xl font-bold uppercase">
					{isEnded ? `${isBallMovingRight ? "Left" : "Right"} side player win!` : "Welcome to Pong"}
				</h1>
				{!isEnded && (
